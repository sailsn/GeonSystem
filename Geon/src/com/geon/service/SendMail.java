...
public class SendMail {
	...
	public void Sendto(String to, String pwd) {
		...
		try {
			...
			String Emailbody = "Hi,<br><br><p style='text-indent: 3em;'><a href='http://localhost:8080/Geon/login.jsp'>Click this Link to activate your Account</a></p><br><br> UserName: "
					+ to
					+ "<br><br>Password:"
					+ pwd
